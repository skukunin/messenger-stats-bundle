...
final class TableRendererTest extends TestCase
{
    ...
    public function testTheTransportTableCarriesOneRowPerQueueAndOneRowPerTransportWithout(): void
    {
        ...
        self::assertContains(['failed', 'doctrine', 'full', 'failed', '7', '0', '0', '0', '86400', '7'], $rows);
    ...
    public function testTheTransportNameIsWrittenOnlyOnTheFirstQueueRow(): void
    {
        $report = StatsReportFixture::of(HealthStatus::Ok, [
            TransportStats::full('async', 'doctrine', false, [
    ...
    {
        $report = StatsReportFixture::of(HealthStatus::Ok, [
            TransportStats::full('async', 'doctrine', false, [new QueueStats('default', 0, 0, 0, 0, null, [], false)], []),
    ...
    {
        $report = StatsReportFixture::of(HealthStatus::Ok, [TransportStats::full('async', 'doctrine', false, [], [])]);
    ...
    {
        $report = StatsReportFixture::of(HealthStatus::Ok, [
            TransportStats::full('failed', 'doctrine', true, [], [new FailedMessage('App\Message\SendEmail', null, null, null, 0, null)]),
        ]);
    ...
    {
        $report = StatsReportFixture::of(HealthStatus::Ok, [TransportStats::full('failed', 'doctrine', true, [], [])]);
